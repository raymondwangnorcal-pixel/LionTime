...
test('records each approved poster scan before redirecting without caching', async () => {
  ...
  for (const poster of ['dodge', 'butler', 'dining', 'ferris', 'hewitt']) {
  ...
  assert.deepEqual(store.inspect(), {
    allTime: { dodge: 1, butler: 1, dining: 1, ferris: 1, hewitt: 1 },
    daily: {
      '2026-08-27': { dodge: 1, butler: 1, dining: 1, ferris: 1, hewitt: 1 },
    },
  });
});
