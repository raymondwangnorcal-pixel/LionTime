...
function parseRawHealthSource($) {
  ...
  const records = [
    ...
    rawHealthAvailability(caps.slice(caps.search(/Starting August 17, 2026/i)), { targetId: 'caps', type: 'office-hours', weekdays: [1, 2, 3, 4], pattern: rangePattern('Monday\\s*[-–—]\\s*Thursday[\\s\\S]*?Hours'), reason: 'Main Office', start: '2026-08-17', suffix: 'main-office-weekdays' }),
    rawHealthAvailability(caps.slice(caps.search(/Starting August 17, 2026/i)), { targetId: 'caps', type: 'office-hours', weekdays: [5], pattern: rangePattern('Friday[\\s\\S]*?Hours'), reason: 'Main Office', start: '2026-08-17', suffix: 'main-office-friday' }),
    ...
    rawHealthAvailability(medical, { targetId: 'medical', type: 'office-hours', weekdays: [1, 2, 3, 4], pattern: rangePattern('Monday\\s*[-–—]\\s*Thursday[\\s\\S]*?Hours'), reason: 'Office Hours', suffix: 'office-weekdays' }),
    rawHealthAvailability(medical, { targetId: 'medical', type: 'office-hours', weekdays: [5], pattern: rangePattern('Friday[\\s\\S]*?Hours'), reason: 'Office Hours', suffix: 'office-friday' }),
