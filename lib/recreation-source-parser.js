...
const ACTIVITY_CALENDARS = Object.freeze({
  'blue-gym': Object.freeze({ calendarName: 'University Hall (Blue) Gym', title: 'Blue Gym', suppliesDodgeFallback: true }),
  'levien-gymnasium': Object.freeze({ calendarName: 'Levien Gymnasium Open Recreation', title: null, suppliesDodgeFallback: false }),
  'aerobics-room-4': Object.freeze({ calendarName: 'Aerobics Room 4 Open Recreation', title: 'Aerobics Room 4 Open Recreation', suppliesDodgeFallback: false }),
  'functional-fitness-studio': Object.freeze({ calendarName: 'Functional Fitness Studio Open Recreation', title: 'Functional Fitness Studio Open Recreation', suppliesDodgeFallback: false }),
});
...
export function parseActivityCalendar(payload, { generated } = {}) {
  ...
  for (const text of payload.weeks) {
    for (const event of calendarEvents(text)) {
      if (event.calendarName !== definition.calendarName) return [];
